...
public class SpectacledFlyingFoxEntity extends Bat implements IAnimatable {
    public SpectacledFlyingFoxEntity(EntityType<? extends Bat> p_27412_, Level p_27413_) {
