...
public class GreaterHorseshoeBatEntity extends Bat implements IAnimatable {
    public GreaterHorseshoeBatEntity(EntityType<? extends Bat> p_27412_, Level p_27413_) {
