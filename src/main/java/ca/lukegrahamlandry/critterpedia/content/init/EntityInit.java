...
public class EntityInit {
    ...
    public static final String[] microbats = new String[]{ "eastern_red_bat", "hammer_head_bat", "hoary_bat", "big_eared_bat"};
    public static final String[] megabats = new String[]{"speckled_flying_fox", };
