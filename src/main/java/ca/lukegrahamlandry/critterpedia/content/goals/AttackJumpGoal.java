...
import ca.lukegrahamlandry.critterpedia.content.entity.GreatWhiteSharkEntity;
...
public class AttackJumpGoal extends JumpGoal {
    ...
    public AttackJumpGoal(GreatWhiteSharkEntity pShark, int pInterval) {
        super();
    ...
    public void tick() {
        ...
        if (vec3.y * vec3.y < (double)0.03F && this.shark.getXRot() != 0.0F) {
            this.shark.setXRot(Mth.rotlerp(this.shark.getXRot(), 0.0F, 0.2F));
